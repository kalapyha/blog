			...
			<ul id="mobile-category-menu" class="categories dropdown menu align-right hide-for-large" data-dropdown-menu>
				<li >
			        ...
			        <ul class="menu" style="display:none;">
						<li>
			            	<a href="/ROOT/news">Elementum<span>(1)</span></a>
			            </li>  
			            <li>
			            	<a href="/ROOT/news">Proin<span>(2)</span></a>
			            </li>  
			            <li>
			            	<a href="/ROOT/news">Eleifend<span>(18)</span></a>
			            </li>  
			            <li>
			            	<a href="/ROOT/news">Phasellus<span>(24)</span></a>
			            </li>  
			            <li>
			            	<a href="/ROOT/news">Consectetuer<span>(33)</span></a>
			            </li>  
			            <li>
			            	<a href="/ROOT/news">Ultricies<span>(2)</span></a>
			            </li>  
			            <li>
			            	<a href="/ROOT/news">Mollis<span>(1)</span></a>
			            </li>  
			        </ul>
		        </li>
			</ul>
